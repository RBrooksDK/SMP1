...
I've added a [page](https://github.com/RBrooksDK/SMP1/blob/main/08%20Regression/Calculating_metrics.ipynb) with all the useful formulas for calculating the parameters as well as the performance metrics, $r$ and $r^2$
